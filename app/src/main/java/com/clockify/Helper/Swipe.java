...
public abstract class Swipe extends ItemTouchHelper.SimpleCallback {
    ...
    public Swipe(Context context,RecyclerView recyclerView,int buttonWidth) {
...
//    }
    ...
    public class MyButton {
        private String text;
        private int imageRestId,textSize,color,pos;
        private RectF clickRegion;
        private MyButtonClickListener listener;
        private Context context;
        private Resources resources;

        public MyButton( Context context,String text, int textSize, int imageRestId, int color,  MyButtonClickListener listener) {
            this.text = text;
...
//            this.clickRegion = clickRegion;
        ...
        public void onDraw(Canvas c,RectF rectF,int pos){
            ...
            if(imageRestId==0){
                ...
                Drawable d = ContextCompat.getDrawable(context,imageRestId);
